...
export const POIS: Poi[] = [
  ...
  /* Alltag */
  {
    ...
    desc: {
      ...
      en: "Full-range supermarket, the Heider bakery and a Sparkasse branch in one place — the weekly shop is a short drive. Lidl and Netto in Storkow (13 min) complete the picture.",
    },
  },
  {
    id: "aerzte",
  ...
  },
  {
    ...
    desc: {
      ...
      en: "Grades 1 to 10 at a single site, ten minutes from the house. Kindergartens in neighbouring Wolzig, grammar schools in Königs Wusterhausen.",
    },
  },
  {
    id: "klinikum",
